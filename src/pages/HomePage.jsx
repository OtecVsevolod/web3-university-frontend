    ...
    <div className="home-manifestS">
      <div className="home-container">
        <div className="home-inner">
          ...
          {/* Неоновая вывеска как надпись в старом баре */}
        ...
        <div className="home-section">
          <h3 className="section-title neon-blue">{t('shared_home_path_title')}</h3>
          <ul className="path-list">
            <li>{t('shared_home_path1')}</li>
            <li>{t('shared_home_path2')}</li>
            <li>{t('shared_home_path3')}</li>
            <li>{t('shared_home_path4')}</li>
            <li>{t('shared_home_path5')}</li>
          </ul>
        </div>
